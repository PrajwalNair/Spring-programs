...
<body>
	...
	<form action="send" method="post">
		...
		No of Busses<input type="text" name="noOfBusses" value="${dto.noOfBusses}"><br>
		Location<input type="text" name="location" value="${dto.location}"><br>
		No Of Platform<input type="text" name="noOfPlatform"
				value="${dto.noOfPlatform}"> <br>
			No Of Shop<input type="text" name="noOfShop" value="${dto.noOfShop}"><br>
			 City<input type="text" name="city" value="${dto.city}"> <br><br>
