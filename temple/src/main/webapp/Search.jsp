...
<body>
	...
	<pre>
		...
		MainGod <input type="text" name="mainGod" >
		
		
		<input type="submit" value="Search" style="font-style: italic; font-weight: bolder; background: green; border: thin;opacity: inherit;">
